...
b7 = Bottle.create!(wine_id: w4.id, user_id: u1.id, vendor: "producer", price: 30, drunk: false)
...
n5 = Note.create!(bottle_id: b4.id, appearance: "clear", nose: "avocado squirty cheese", palate: "croque monsieur cauliflower", conclusion: "Brie croque monsieur cauliflower cheese. Brie melted cheese st. agur blue cheese cheesecake stinking bishop swiss red leicester stilton. Cheese triangles gouda cheeseburger st. agur blue cheese monterey jack cheeseburger cheese triangles ricotta. Danish fontina roquefort squirty cheese.", rating: "3", maturity: "Will improve")
